bq. *Announcement*. "camel-scala-extra" code has been merged into Apache Camel @camel-scala@ component due to release as version 2.11, see "ticket":https://issues.apache.org/jira/browse/CAMEL-6182 This effectively means camel-scala-extra's end of life.
