...
"camel-scala" provides a useful implicit conversion to enrich objects of `Exchange`. Consult the source code of "camel-scala" since there is no javadoc/scaladoc published. Basically you can do the following and alike:
