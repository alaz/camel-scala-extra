...
If your function returns @Unit@, you should not append @.toIn@ or @.toOut@: I doubt you intentionally wanted to set the message's body to @Unit@. You should not use such functions in @filter@ as well. You will get runtime exception if you'd try to.
